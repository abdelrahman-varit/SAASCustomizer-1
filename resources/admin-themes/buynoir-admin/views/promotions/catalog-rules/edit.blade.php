            ...
            <form method="POST" action="{{ route('admin.catalog-rules.update', $catalogRule->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="page-content">
                    <div class="form-container">
                        ...
                        <div slot="header">{{ __('admin::app.promotions.catalog-rules.rule-information')  }}</div> 
                        <div slot="body">
                        ...
                        <div slot="header">{{ __('admin::app.promotions.catalog-rules.conditions')  }}</div>     
                        <div slot="body">
                        ...
                        <div slot="header">{{ __('admin::app.promotions.catalog-rules.actions')  }}</div>  
                        <div slot="body">
