                    ...
                    <div class="form-container">
                        ...
                        <div class="details">
                            ...
                            <div class="product-ratings">
                                ...
                                @else
                                    <img src="{{asset('/themes/myshop/assets/images/icons/rating-black.png')}}" style="height:13px;width:13px"/>
                                    <img src="{{asset('/themes/myshop/assets/images/icons/rating-black.png')}}" style="height:13px;width:13px"/>
                                    <img src="{{asset('/themes/myshop/assets/images/icons/rating-black.png')}}" style="height:13px;width:13px"/>
                                    <img src="{{asset('/themes/myshop/assets/images/icons/rating-black.png')}}" style="height:13px;width:13px"/>
                                    <img src="{{asset('/themes/myshop/assets/images/icons/rating-black.png')}}" style="height:13px;width:13px"/>
                            ...
                            <div class="others-information" style="margin-top:30px">
                                ...
                                {{-- <div class="" style="align-items:center;display:flex;flex-direction:row;gap:30px;margin-top:25px;">
                                    ...
                                    <a href="#"><img src="{{asset('/themes/myshop/assets/images/facebook-round.png')}}" style="height:32px;width:32px;vertical-align:middle"/></a> &nbsp; 
                                    <a href="#"><img src="{{asset('/themes/myshop/assets/images/linkedin-round.png')}}" style="height:32px;width:32px;vertical-align:middle"/></a> &nbsp; 
                                    <a href="#"><img src="{{asset('/themes/myshop/assets/images/twitter-round.png')}}" style="height:32px;width:32px;vertical-align:middle"/></a> &nbsp; 
                                    <a href="#"><img src="{{asset('/themes/myshop/assets/images/pinterest-round.png')}}" style="height:32px;width:32px;vertical-align:middle"/></a> &nbsp; 
                                    </div>
                                </div> --}}
