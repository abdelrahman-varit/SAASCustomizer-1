...
{!! view_render_event('bagisto.shop.products.list.card.before', ['product' => $product]) !!}
    @if (isset($list) && $list)
        <div class="col-12 lg-card-container list-card product-card row buynoir-product-card d-flex">
            <div class="col-3">
        ...
        <div class="card grid-card product-card-new buynoir-product-card d-flex row">
            ...
            <div class="col-8 ">
                    ...
                    <div class="row d-flex">
                        <div class="cart-wish-wrap  col-6">
                            @include ('shop::products.add-to-cart-related', [
                                'product'           => $product,
                        ...
                        <div class="col-6 pull-right">
                            @if (isset($product->id) && $product->id)
                                ...
                                >
                                <sub><i class='material-icons'>highlight_off</i></sub>
                                Remove
                                </a>
                            @endif
