...
<div class="header" id="header">
        ...
        <div class="header-top">
            <div class="container header-logo-searchbar">
                        ...
                        @if ($showWishlist)
                            <li class="compare-dropdown-container">
                                <a href="{{ route('customer.wishlist.index') }}" style="color: rgb(36, 36, 36);">
                                    <div><i class="icon wishlist-icon"></i></div>
                                    <div class="name">{{ __('shop::app.header.wishlist') }}</div>
                                </a>
                            </li>
                        @endif
                        @php
                        ...
                        @if ($showCompare)
                            <li class="compare-dropdown-container">
                                <a
                                    ...
                                    style="color: #242424;"
                                    >
                                    <div><i class="icon compare-icon"></i></div>
                                    <div>
                                        <span class="name">
