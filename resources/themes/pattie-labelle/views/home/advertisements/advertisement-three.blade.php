    ...
    @if ($advertisementThree)
        ...
        <div class="main-container-wrapper advertisement-three-container">
            <div class="col-4">
                ...
                @else
                    <a @if (isset($one)) href="{{ $one }}" @endif >
                        <img class="col-12" src="{{ asset('/themes/pattie-labelle/assets/images/banner/advertise-2-1.jpg') }}" />
                    </a>
                @endif
            </div>
            ...
            <div class="col-4">
                ...
                @else
                    <a @if (isset($one)) href="{{ $one }}" @endif >
                        <img class="col-12" src="{{ asset('/themes/pattie-labelle/assets/images/banner/advertise-2-2.jpg') }}" />
                    </a>
            ...
            <div class="col-4">
                ...
                @else
                    <a @if (isset($one)) href="{{ $one }}" @endif >
                        <img class="col-12" src="{{ asset('/themes/pattie-labelle/assets/images/banner/advertise-2-3.jpg') }}" />
                    </a>
