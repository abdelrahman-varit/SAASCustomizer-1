...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/shop.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/greedynav.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/stellarnav.min.css') }}">

    <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/custom.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/responsive.css') }}">
    ...
    @if($theme_color!=="default" && !empty($theme_color))
        <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/colors/'.$theme_color.'.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('themes/pattie-labelle/assets/css/colors/blue.css') }}">
    @endif
...
<body @if (core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
    ...
    <div class="se-pre-con">
        <div class="se-pre-con-inner">
            ...
            @else
                <img class="se-pre-con-logo" src="{{ asset('themes/pattie-labelle/assets/images/logo.svg') }}" />
            @endif
        </div>
    </div>
    ...
    <script type="text/javascript" src="{{ asset('themes/pattie-labelle/assets/js/shop.js') }}"></script>
    ...
    <script src="{{ asset('themes/pattie-labelle/assets/js/greedynav.js') }}"></script>
    <script src="{{ asset('themes/pattie-labelle/assets/js/stellarnav.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/6.7.0/swiper-bundle.min.js"></script>
    
    <script type="text/javascript" src="{{ asset('themes/pattie-labelle/assets/js/scripts.js') }}"></script>
