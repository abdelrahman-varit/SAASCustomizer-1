                ...
                <div class="product-card">
                    ...
                    <div class="product-image">
                        <a href="/" title="Demo product">
                            <img src="{{ asset('/themes/aretha-franklin/assets/images/product/newproduct-0'.$i.'.jpg') }}" onerror="this.src='{{ asset('/themes/aretha-franklin/assets/images/product/featured-01.jpg') }}'"/>
                        </a>
                    </div>
