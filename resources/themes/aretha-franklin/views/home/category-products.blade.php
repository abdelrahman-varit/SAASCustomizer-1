                    ...
                    <div class="product-card">
                        ...
                        <div class="product-image">
                            <a href="/" title="Demo product">
                                <img src="{{ asset('/themes/aretha-franklin/assets/images/product/catproduct-0'.$i.'.png') }}" onerror="this.src='{{ asset('/themes/aretha-franklin/assets/images/product/featured-01.jpg') }}'"/>
                            </a>
                        </div>
