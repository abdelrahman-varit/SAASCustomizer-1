            ...
            <div class="account-layout">
                ...
                <div class="account-head">
                    ...
                    <span class="account-action">
                        <a href="{{ route('customer.profile.edit') }}" class="btn btn-primary">{{ __('shop::app.customer.account.profile.index.edit') }}</a>
                    </span>
                ...
                @if(!empty($customer))
                    <div class="account-profile-info">
                        ...
                        <button type="submit" @click="showModal('deleteProfile')" class="btn btn-md btn-primary">{{ __('shop::app.customer.account.address.index.delete') }}</button>
