                ...
                <div class="product-card">
                    ...
                    <div class="product-image">
                        <a href="/" title="Demo product">
                            <img src="{{ asset('/themes/toni-braxton/assets/images/product/featured-0'.$i.'.jpg') }}" onerror="this.src='{{ asset('/themes/toni-braxton/assets/images/product/featured-01.jpg') }}'"/>
                        </a>
                    </div>
