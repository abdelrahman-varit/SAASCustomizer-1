    ...
    @if ($advertisementTwo)
        ...
        <div class="main-container-wrapper advertisement-three-container">
            <div class="col-4">
                ...
                @else
                    <a @if (isset($one)) href="{{ $one }}" @endif >
                        <img class="col-12" src="{{ asset('/themes/toni-braxton/assets/images/banner/advertise-3-1.jpg') }}" />
                    </a>
            ...
            <div class="col-4">
                @if ( isset($advertisementTwo[1]))
                    ...
                    @else
                <a @if (isset($one)) href="{{ $one }}" @endif >
                    <img class="col-12" src="{{ asset('/themes/toni-braxton/assets/images/banner/advertise-3-2.jpg') }}" />
                </a>
            ...
            <div class="col-4">
                ...
                @if ( isset($advertisementTwo[2]))
                    ...
                    @else
                <a @if (isset($one)) href="{{ $one }}" @endif >
                    <img class="col-12" src="{{ asset('/themes/toni-braxton/assets/images/banner/advertise-3-3.jpg') }}" />
                </a>
