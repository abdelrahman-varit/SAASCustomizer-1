            ...
            <div class="header-top">
                <div class="left-content">
                    ...
                    <div class="col-2 locale-img">
                        @if ($localeImage)
                            <img src="{{ asset('/storage/' . $localeImage) }}" onerror="this.src = '/themes/toni-braxton/assets/images/icons/en.png'" height="13" />
                        @elseif (app()->getLocale() == 'en')
                            <img src="{{ asset('/themes/toni-braxton/assets/images/icons/en.png') }}" height="13" />
                        @endif
                    </div>
