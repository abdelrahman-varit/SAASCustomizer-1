            ...
            <div class="row gy-4 gy-md-0">
                <div class="col-md-4">
                    <a href="{{ isset($one) ? $one : 'javascript:void(0)' }}">
                        ...
                        @else
                            <img src="{{ asset('/themes/beshop/assets/img/demo/offer-banner-1.jpg') }}" alt="offer-banner-1">
                        @endif
                    </a>
                </div>
...
@if (! $isRendered)
    ...
    <div class="container advertisement">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-4">
                <a href="{{ isset($one) ? $one : 'javascript:void(0)' }}"><img src="{{ asset('/themes/beshop/assets/img/demo/offer-banner-1.jpg') }}" alt="offer-banner-1"></a>
            </div>
            <div class="col-md-4 advertisement-row-2">
                <div class="row row-cols-1 gy-4">
                    <div class="col">
                        <a href="{{ isset($two) ? $two : 'javascript:void(0)' }}"><img src="{{ asset('/themes/beshop/assets/img/demo/offer-banner-2.jpg') }}" alt="offer-banner-2"></a>
                    </div>
                    <div class="col">
                        <a href="{{ isset($three) ? $three : 'javascript:void(0)' }}"><img src="{{ asset('/themes/beshop/assets/img/demo/offer-banner-3.jpg') }}" alt="offer-banner-3"></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <a href="{{ isset($four) ? $four : 'javascript:void(0)' }}"><img src="{{ asset('/themes/beshop/assets/img/demo/offer-banner-4.jpg') }}" alt="offer-banner-4"></a>
            </div>
        </div>
    </div>
    <!-- Advertisement End -->
