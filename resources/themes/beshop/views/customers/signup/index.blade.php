...
@section('content-wrapper')
    <div style="background: url({{ asset('themes/beshop/img/demo/bg-image.jpg') }}) no-repeat center bottom; background-size: cover">
        <div class="py-5"></div>
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-6 bg-white auth-container">
                    ...
                    <form action="{{ route('customer.register.create') }}" method="POST" class="px-3 px-lg-4 mb-4 needs-validation" novalidate>
                        ...
                        <div class="mb-4 row">
                            <label for="password_confirmation" class="col-sm-4 col-form-label">{{ __('shop::app.customer.signup-form.password') }} <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
