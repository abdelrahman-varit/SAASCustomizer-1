    ...
    <div class="container auth-container" style="background-color: #DAF3F7">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 auth-content">
                ...
                <h4 class="text-center pb-3 mb-3 mt-1">{{ __('shop::app.customer.forgot-password.title') }}</h4>
                ...
                <form method="POST" action="{{ route('customer.forgot-password.store') }}" class="row g-3 mb-4 px-3 px-lg-5 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-dark rounded-0 w-100 btn-lg fw-bold mt-3">{{ __('shop::app.customer.forgot-password.submit') }}</button>
                    </div>
                    <div class="col-12">
