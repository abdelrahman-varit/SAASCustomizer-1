                    ...
                    <ul class="nav">
                        ...
                        @if (core()->getCurrentChannel()->locales->count() > 0)
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link text-black dropdown-toggle" data-bs-toggle="dropdown">
                                    @if ($localeImage)
                                        <img src="{{ asset('/storage/' . $localeImage) }}" onerror="this.src = '/themes/beshop/assets/img/flags/en.png'" class="me-1"/> English
                                    @elseif (app()->getLocale() == 'en')
                                        <img src="{{ asset('/themes/beshop/assets/img/flags/en.png') }}" alt="English" class="me-1"/> English
                                    @elseif (app()->getLocale() == 'bn')
                                        <img src="{{ asset('/themes/beshop/assets/img/flags/bn.png') }}" alt="Bangla" class="me-1"/> Bangla
                                    @endif
                                </a>
                                <ul class="dropdown-menu">
                                    @foreach (core()->getCurrentChannel()->locales as $locale)
                                        <li>
                                            ...
                                            @else
                                                <a class="dropdown-item" href="?locale={{ $locale->code }}"><img src="{{ asset('themes/beshop/assets/img/flags/'.strtolower($locale->code).'.png') }}" alt="{{ $locale->code }}" class="me-1"> {{ $locale->name }}</a>
                                            @endif
                                        </li>
                                    @endforeach
                                </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand" href="{{ route('shop.home.index') }}">
                    ...
                    @else
                        <img class="logo" src="{{asset('/themes/beshop/assets/img/demo/Buynoir-2.png') }}" alt="Buynoir">
                    @endif
                </a>
                        ...
                        @if($showWishlist)
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('customer.wishlist.index') }}">
                                    ...
                                    <span class="wcc-label">{{ __('shop::app.header.wishlist') }}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if ($showCompare)
                            <li class="nav-item">
                                ...
                                class="nav-link">
                                    ...
                                    <span class="wcc-label">{{ __('shop::app.customer.compare.text') }}</span>
                                </a>
                            </li>
                        @endif
