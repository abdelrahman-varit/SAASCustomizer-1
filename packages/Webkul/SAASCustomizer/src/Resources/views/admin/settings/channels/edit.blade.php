            ...
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        ...
                        {{ __('admin::app.settings.channels.edit-title') }} hell all
                    </h1>
                </div>
                    ...
                    <div slot="header">{{ __('admin::app.settings.channels.general') }}</div>
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('hostname') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="hostname" v-validate="'required'" name="hostname" value="{{ $channel->hostname }}" placeholder="https://www.example.com" data-vv-as="&quot;{{ __('admin::app.settings.channels.hostname') }}&quot;"/>
