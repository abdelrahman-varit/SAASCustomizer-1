                    ...
                    <accordian :title="'{{ __('saassubscription::app.super-user.plans.plan-limitation') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('allowed_products') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|numeric|min:0'" class="control" id="allowed_products" name="allowed_products" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.allowed-products') }}&quot;" value="{{ old('allowed_products') ?: $plan->allowed_products }}" />
                            ...
                            <div class="control-group" :class="[errors.has('allowed_categories') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|numeric|min:0'" class="control" id="allowed_categories" name="allowed_categories" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.allowed-categories') }}&quot;" value="{{ old('allowed_categories') ?: $plan->allowed_categories }}" />
                            ...
                            <div class="control-group" :class="[errors.has('allowed_attributes') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|numeric|min:0'" class="control" id="allowed_attributes" name="allowed_attributes" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.allowed-attributes') }}&quot;" value="{{ old('allowed_attributes') ?: $plan->allowed_attributes }}" />
                            ...
                            <div class="control-group" :class="[errors.has('allowed_attribute_families') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|numeric|min:0'" class="control" id="allowed_attribute_families" name="allowed_attribute_families" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.allowed-attribute-families') }}&quot;" value="{{ old('allowed_attribute_families') ?: $plan->allowed_attribute_families }}" />
                            ...
                            <div class="control-group" :class="[errors.has('allowed_channels') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|numeric|min:0'" class="control" id="allowed_channels" name="allowed_channels" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.allowed-channels') }}&quot;" value="{{ old('channels') ?: $plan->allowed_channels }}" />
                            ...
                            <div class="control-group" :class="[errors.has('allowed_orders') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required|numeric|min:0'" class="control" id="allowed_orders" name="allowed_orders" data-vv-as="&quot;{{ __('saassubscription::app.super-user.plans.allowed-orders') }}&quot;" value="{{ old('allowed_orders') ?: $plan->allowed_orders }}" />
