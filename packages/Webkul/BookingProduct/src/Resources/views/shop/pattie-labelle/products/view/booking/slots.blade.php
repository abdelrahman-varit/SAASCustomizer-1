...
@push('scripts')
        ...
        <div class="book-slots">
            ...
            <div class="control-group-container">
                <div class="control-group date" :class="[errors.has('booking[date]') ? 'has-error' : '']">
                    <date @onChange="dateSelected($event, 'date')">
                        <input type="text" v-validate="'required'" autocomplete="off" name="booking[date]" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.shop.products.date') }}&quot;"/>
                    </date>
    ...
    <script>
        ...
        Vue.component('book-slots', {
            ...
            methods: {
                dateSelected: function(date, curObj) {
                    var this_this = this;
                    if(curObj!="date"){
                        return false;
                    }
