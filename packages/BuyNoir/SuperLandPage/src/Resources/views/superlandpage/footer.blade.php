		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="single-footer-widget">
					...
					<p>BuyNoir is the platform that powers black and brown owned businesses. Bring your black and brown owned business online with the world’s only black owned ecommerce platform.</p>
			...
			<div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6">
				<div class="single-footer-widget pl-5">
					...
					<ul class="footer-links-list">
						...
						<li><a href="https://docs.buynoir.co" target="_blank">Documentation</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="single-footer-widget">
					<h3>From Atlanta with <i class='bx bxs-heart text-danger'></i></h3>
				</div>
			</div>
		</div>
